<div class="justify-center ">
    ...
    <div class="justify-center flex p-8">
        <h1 class="font-bold text-2xl leading-[1.32]">
            Welcome back to Aventones
        </h1>
    </div>
    <form action="/post/login.php" method="POST" class="flex flex-col items-center dark:bg-gray-800">
        <div class="relative z-0 w-full mb-5 group m-8">
